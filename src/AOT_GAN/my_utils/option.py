...
# data specifications 
parser.add_argument('--dir_image', type=str, default=DIR_PROJECT_DATA_RAW,
                    help='image dataset directory')
#parser.add_argument('--dir_image', type=str, default=os.path.join(DIR_PROJECT_DATA_RAW_CA_ISIC18),
                    #help='image dataset directory')
parser.add_argument('--dir_mask', type=str, default=DIR_PROJECT_DATA_MASKS,
                    help='mask dataset directory')

parser.add_argument('--dir_image_test', type=str, default=DIR_PROJECT_DATA_RAW_HAIR,
                    help='mask dataset directory')
#parser.add_argument('--dir_mask', type=str, default=os.path.join(DIR_PROJECT_DATA_MASKS_CA_ISIC18),
                    #help='mask dataset directory')

parser.add_argument('--train_seed', type=int, default=0,
                    help='seed for train split')
...
parser.add_argument('--save_dir', type=str, default= DIR_PROJECT_DATA_REPORTS_AOTGAN,
...
parser.add_argument('--pre_train', type=str, default= os.path.join(DIR_PROJECT_DATA_REPORTS_AOTGAN, 'G0000050.pt'  ),
                    help='path to pretrained models')
parser.add_argument('--outputs', type=str, default= DIR_PROJECT_DATA_INPAINTED_RESULTS,
